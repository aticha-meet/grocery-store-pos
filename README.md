...
> **รุ่นล่าสุด: v0.2.1** — ทดสอบแล้วบน Windows 10/11 (x64)

| ไฟล์                               | ขนาด   | คำอธิบาย                                                                     |
| ---------------------------------- | ------ | ---------------------------------------------------------------------------- |
| `Baan Ran POS_0.2.1_x64-setup.exe` | ~38 MB | ตัวติดตั้ง Windows 64-bit (NSIS) ที่ `src-tauri/target/release/bundle/nsis/` |
